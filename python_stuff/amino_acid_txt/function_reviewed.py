...
##import learning-python.python_stuff.main.xyz_file_function as eden_script
##eden_script.get_file lines()
##
##from learning-python.python_stuff.main.xyz_file_function import get_file lines
##get_file_lines()
##
##from learning-python.python_stuff.main.xyz_file_function import * # import all
##get_file_lines()

import learning_python.python_stuff.main.xyz_file_function as pl
...
def text_to_matrix(file_name):
    ...
    """
    splitted_file_lines=pl.get_tabular_text_to_matrix(file_name)
...
def text_to_dataframe(file_name, columns=None):
    ...
    2    ATOM   3510         C             THR  ...  135.291           1.00  11.70    C 
    """
    matrix=text_to_matrix(file_name)
...
if __name__=='__main__':
    ...
    list_of_files=os.listdir(r'C:\Users\edenspec\Documents\GitHub\learning-python\python stuff\amino acid txt files')
...
##    print(list_of_pdb_files)
    mask1=create_mask_from_column(dataframe,'Atom','H')
